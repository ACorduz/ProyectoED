...
public class Beneficiary extends User implements Serializable{
    ...
    public Beneficiary(int NumberProductSelect, int QuantityAllow, String name,String lastName, String email, String typeDocument ,String document, String password) {
    ...
    public Beneficiary(String name,String lastName, String email, String typeDocument ,String document, String password) {
        super(name, lastName ,email,typeDocument,document, password, "Beneficiario");
        NumberProductSelect=0;
    }
