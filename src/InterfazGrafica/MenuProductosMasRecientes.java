...
public class MenuProductosMasRecientes extends javax.swing.JFrame {
    ...
    public MenuProductosMasRecientes() {
        ...
        if (listaProductos != null) {
            for (int i = 0; i < listaProductos.size(); i++) {
                ...
                productEmailMap.insert(nombre, email); // Asociar el nombre del producto con su correo electrónico
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/mas-reciente.png"))); // NOI18N
